...
[![Build Status](https://travis-ci.org/SunMaybo/hystrix-go.png?branch=master)](https://travis-ci.org/SunMaybo/hystrix-go)
[![GoDoc Documentation](http://godoc.org/github.com/SunMaybo/hystrix-go/hystrix?status.png)](https://godoc.org/github.com/SunMaybo/hystrix-go/hystrix)
...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/SunMaybo/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/SunMaybo/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/SunMaybo/hystrix-go```
- ```go test ./...```
